...
*/
	function loadStatsPage(){
		...
		for(row_counter=2; row_counter<table.rows.length; row_counter++){
			...
			oppose = parseInt(table.rows[row_counter].cells[3].innerHTML);
			if(home > oppose){
				wins++;
...
*/
	function loadPlayersPage(){
		...
		{
			<a href="#" onclick="switchPlayers(index)"> players[index].name </a>
			document.getElementById('player_selector').innerHTML=players[index].name;
		}
